...
class ShoppingCartItem(Model, db.Model):
    __tablename__ = "shopping_cart_item"
    __name__ = "ShoppingCartItem"

    _shopping_cart_id = sa.Column(sa.BIGINT,
                                    sa.ForeignKey('shopping_cart.shopping_cart_id'),
                                    name="shopping_cart_id",
                                    primary_key=True,
                                    doc="primary key")
    _item_id = sa.Column(sa.BIGINT, name="item_id", primary_key=True, doc="primary key")
    _quantity = sa.Column(sa.BIGINT, name="quantity", nullable=False)
    _price = sa.Column(sa.DECIMAL, name="price", nullable=False)
    _status = sa.Column(sa.INT, name="status", nullable=False)
    # cart = orm.relationship("ShoppingCart", foreign_keys=[_shopping_cart_id])
